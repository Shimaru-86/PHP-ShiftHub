  ...
  <div class="w3-display-container" style="height: 100vh;">
    <div class="w3-display-middle" style="width: 100%; max-width: 600px;">
      ...
      <form 
        ...
        <h2 class="w3-center">Registrar Novo Usuário</h2>

        <div class="w3-row w3-section">
          <div class="w3-col" style="width:50px"><i class="w3-xxlarge fa fa-user"></i></div>
          <div class="w3-rest">
            <input class="w3-input w3-border" type="text" name="username" placeholder="Nome de usuário" required>
          </div>
        </div>
        ...
        <div class="w3-row w3-section">
          ...
          <div class="w3-rest">
            <input class="w3-input w3-border" type="password" name="confirm_password" placeholder="Confirme a senha" required>
          </div>
        </div>

        <p class="w3-center">
          <button class="w3-button w3-section w3-blue w3-ripple w3-round-large"> Registrar </button>
        </p>
      </form>
    </div>
  </div>
